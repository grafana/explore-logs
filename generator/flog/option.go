...
const (
	version = "0.4.4"
	usage   = `flog is a fake log generator for common log formats
...
var (
	validFormats = []string{"apache_common", "apache_combined", "apache_error", "rfc3164", "rfc5424", "common_log", "json"}
	validTypes   = []string{"stdout", "log", "gz"}
)
