    ...
    <div data-testid={testIds.appConfig.container}>
      <FieldSet label="Settings">
        <Field
          ...
          description={
            <span>
              The maximum interval that can be selected in the time picker within the Logs Drilldown app. If empty,
              users can select any time range interval in Logs Drilldown. <br />
