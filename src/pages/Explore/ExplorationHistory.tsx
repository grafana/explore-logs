...
import { LogExploration, LogExplorationState } from './LogExploration';
...
export interface ExplorationHistoryStep {
  ...
  explorationState: LogExplorationState;
  parentIndex: number;
}
...
export class ExplorationHistory extends SceneObjectBase<DataExplorationsHistoryState> {
  ...
  public addExplorationStep(exploration: LogExploration, type: ExplorationStepType) {
