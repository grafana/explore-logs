...
import { TableColumnContextProvider } from '../Context/TableColumnsContext';
import { useUrlParamsContext } from '../Context/UrlParamsContext';
import { Table } from '../Table/Table';
import { FieldNameMeta, FieldNameMetaStore } from '../Table/TableTypes';
  ...
  return (
    <section className={styles.section}>
      <TableColumnContextProvider initialColumns={pendingLabelState}>
        <Table logsFrame={logsFrame} timeZone={timeZone} height={height - 400} width={width - 40} labels={labels} />
