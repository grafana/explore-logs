...
export const VAR_LINE_FILTER_AD_HOC = 'lineFilters';
export const VAR_LINE_FILTER_AD_HOC_EXPR = '${lineFilters}';
export const LOG_STREAM_SELECTOR_EXPR = `{${VAR_LABELS_EXPR}} ${VAR_PATTERNS_EXPR} ${VAR_METADATA_EXPR} ${VAR_LINE_FILTER_EXPR} ${VAR_LINE_FILTER_AD_HOC_EXPR} ${VAR_LEVELS_EXPR} ${VAR_LOGS_FORMAT_EXPR} ${VAR_FIELDS_EXPR}`;
...
export const DETECTED_FIELD_VALUES_EXPR = `{${VAR_LABELS_EXPR}} ${VAR_PATTERNS_EXPR} ${VAR_METADATA_EXPR} ${VAR_LINE_FILTER_EXPR} ${VAR_LINE_FILTER_AD_HOC_EXPR} ${VAR_LEVELS_EXPR} ${VAR_LOGS_FORMAT_EXPR} ${PENDING_FIELDS_EXPR}`;
export const DETECTED_METADATA_VALUES_EXPR = `{${VAR_LABELS_EXPR}} ${VAR_PATTERNS_EXPR} ${PENDING_FIELDS_EXPR} ${VAR_LINE_FILTER_EXPR} ${VAR_LINE_FILTER_AD_HOC_EXPR} ${VAR_LEVELS_EXPR} ${VAR_LOGS_FORMAT_EXPR} ${VAR_FIELDS_EXPR}`;
export const DETECTED_LEVELS_VALUES_EXPR = `{${VAR_LABELS_EXPR}} ${VAR_PATTERNS_EXPR} ${VAR_METADATA_EXPR} ${VAR_LINE_FILTER_EXPR} ${VAR_LINE_FILTER_AD_HOC_EXPR} ${PENDING_FIELDS_EXPR} ${VAR_LOGS_FORMAT_EXPR} ${VAR_FIELDS_EXPR}`;
